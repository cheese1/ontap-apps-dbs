== Learn about vSphere Metro Storage Cluster with NetApp ONTAP
...
image:/media/vmsc_image2.png[A diagram of a computer network Description automatically generated,width=624,height=440]Refer to https://docs.netapp.com/us-en/ontap/smbc/index.html[NetApp Docs] for specific design and deployment information for SnapMirror active sync.
