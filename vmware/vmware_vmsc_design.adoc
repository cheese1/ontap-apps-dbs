...
. Right-click the data center object and select New Cluster. Under basics ensure you have enabled vSphere DRS and vSphere HA. Complete the wizard. image::../media/vmsc_1.png[A screenshot of a computer Description automatically generated,width=624,height=302]
. Select the cluster and go to the configure tab. Select vSphere HA and click edit.
. Under Host Monitoring, select the Enable Host Monitoring option. image::../media/vmsc_2.png[A screenshot of a computer Description automatically generated,width=624,height=475]
. While still on the Failures and Responses tab, Under VM Monitoring, select the VM Monitoring Only option or VM and Application Monitoring option. image::../media/vmsc_3.png[A screenshot of a computer Description automatically generated,width=624,height=480]
. Under Admission Control, set the HA admission control option to cluster resource reserve; use 50% CPU/MEM. image::../media/vmsc_4.png[A screenshot of a computer Description automatically generated,width=624,height=479]
. Click “OK”.
. Select DRS and click EDIT.
. Set the automation level to manual unless required by your applications. image::../media/vmsc_5.png[width=624,height=336]
...
image::../media/vmsc_6.png[A screenshot of a computer Description automatically generated,width=624,height=540]
...
image::../media/vmsc_7.png[A screenshot of a computer Description automatically generated,width=624,height=545]
...
image::../media/vmsc_8.png[A screenshot of a computer Description automatically generated,width=474,height=364]
...
image::../media/vmsc_9.png[A close up of a text Description automatically generated,width=528,height=94]
...
image::../media/vmsc_10.png[A screenshot of a computer Description automatically generated,width=624,height=241]

[arabic, start=6]
. Select the HA cluster and click Next.

image::../media/vmsc_11.png[A screenshot of a computer Description automatically generated,width=624,height=149]

[arabic, start=7]
. Select the datastores belonging to site A and click Next.

image::../media/vmsc_12.png[A screenshot of a computer Description automatically generated,width=624,height=134]
