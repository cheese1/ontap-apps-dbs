---
sidebar: sidebar
permalink: hana/aff-fc/architecture_overview.html
keywords:
summary:
---
= Overview
...
[.lead]
SAP HANA hosts are connected to storage controllers using a redundant FCP infrastructure and multipath software. 
