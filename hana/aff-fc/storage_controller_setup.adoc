...
image:image12.jpg[Error: Missing Graphic Image]
...
image:image13.jpeg[Error: Missing Graphic Image]
...
image:image18.jpeg[Error: Missing Graphic Image]

. Confirm that storage is successfully provisioned.

image:image19.jpeg[Error: Missing Graphic Image]
