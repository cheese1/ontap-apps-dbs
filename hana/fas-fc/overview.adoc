---
sidebar: sidebar
permalink: hana/fas-fc/overview.html
...
For a complete list of NetAppâ€™s certified storage solutions for SAP HANA, see the https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=v:deCertified;ve:13[certified and supported SAP HANA hardware directory^].

[NOTE]
This section is based on TR-4384: SAP HANA on NetApp FAS Systems with Fibre Channel Protocol Configuration Guide
...
In an SAP HANA multiple-host environment, the standard SAP HANA storage connector is used to provide fencing in the event of an SAP HANA host failover. Refer to the relevant SAP notes for operating system configuration guidelines and HANA-specific Linux kernel dependencies. For more information, see https://launchpad.support.sap.com/[SAP Note 2235581 â€“ SAP HANA Supported Operating Systems^].
