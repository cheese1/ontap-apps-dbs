...
image:image13.jpg[Error: Missing Graphic Image]
...
image:image14.jpeg[Error: Missing Graphic Image]
...
image:image15.jpeg[Error: Missing Graphic Image]
...
image:image16.jpeg[Error: Missing Graphic Image]
...
image:image17.jpeg[Error: Missing Graphic Image]
...
image:image19.jpg[Error: Missing Graphic Image]
...
+
image:image20.jpeg[Error: Missing Graphic Image]

. Enter the LUN name, select the LUN type, and enter the size of the LUN.
+
image:image21.jpeg[Error: Missing Graphic Image]

. Enter the volume name and the hosting aggregate.
+
image:image22.jpeg[Error: Missing Graphic Image]

. Select the igroups to which the LUNs should be mapped.
+
image:image23.jpeg[Error: Missing Graphic Image]

. Provide the QoS settings.
+
image:image24.jpeg[Error: Missing Graphic Image]

. Click Next on the Summary page.
+
image:image25.jpeg[Error: Missing Graphic Image]

. Click Finish on the Completion page.
+
image:image26.jpeg[Error: Missing Graphic Image]
...
+
image:image27.jpeg[Error: Missing Graphic Image]
