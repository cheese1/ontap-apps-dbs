---
sidebar: sidebar
permalink: hana/fas-nfs/overview.html
...
[NOTE]
This documentation replaces previously published technical report _TR-4290: SAP HANA on NetApp FAS systems with NFS Configuration guide_
