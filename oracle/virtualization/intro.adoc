...
[TIP]
*NetApp recommends* to avoid placing Oracle data on a datastore to achieve optimum performance and manageability,. Use guest-owned file systems such as NFS or iSCSI file systems managed by the guest or with RDMs.
