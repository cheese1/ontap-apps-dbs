...
NFS performance on Linux depends on a parameter called `tcp_slot_table_entries`. Please see the link:../../common/storage-configuration/nfs.html[NFS] for critical information.
