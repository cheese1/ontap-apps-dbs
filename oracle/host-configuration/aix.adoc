...
keywords: TR-3633, oracle, database, ontap, aix, cio
...
The following table lists the AIX NFS mount options for a single instance.
...
.^|`rw,bg,hard,[vers=3,vers=4,vers=4.1],proto=tcp,timeo=600,rsize=262144,wsize=262144`
.^|`ORACLE_HOME`
.^|`rw,bg,hard,[vers=3,vers=4,vers=4.1],proto=tcp,timeo=600,rsize=262144,wsize=262144,intr`
|===
...
Datafiles
Redo logs
.^|`rw,bg,hard,[vers=3,vers=4,vers=4.1],proto=cp,timeo=600,rsize=262144,wsize=262144,nointr, noac`
.^|`CRS/Voting`
