...
[NOTE]
See the note about `nosharecache` in the section link:../host-configuration/linux.html#linux-direct-nfs[Linux NFS Mount Options] for a Linux-specific dNFS issue that can produce unusual results.
