...
image:filegroups.png[Error: Missing Graphic Image]
...
image:security-policy.png[Error: Missing Graphic Image]
...
image:zeroing.png[Error: Missing Graphic Image]
...
image:maintenance.png[Error: Missing Graphic Image]
