...
NetApp have different ways to compress a database using ONTAP features explained in this link:mssql/CPUConfiguration.html[link].link:common/ontap/efficiency.html[linka]