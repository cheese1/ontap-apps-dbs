...
[.lead]
This section contains the high-level recommendations for configuring SAN storage. Additional notes can be found in the Hosts configuration guides for specific application elsewhere in this document.
