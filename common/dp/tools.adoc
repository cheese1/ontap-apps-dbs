...
[.lead]
The primary value of ONTAP in an application environment comes from the core ONTAP technologies such as instant snapshots, simple SnapMirror replication, and efficient creation of FlexClone volumes. 
