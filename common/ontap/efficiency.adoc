...
[NOTE]
See the section link:../thin_provisioning.html#Fractional%20reservations[Fractional Reservations] for an explanation of the interaction between compression and fractional reservation.
